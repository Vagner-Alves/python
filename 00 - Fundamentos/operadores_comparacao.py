...
são operadores utilizando para comparar valores no python, o valor de retorno das comparações
sempre será booleano, True quando verdadeiro e False quando falso.
